...
function Tab(){
  return (
    ...
    >
      <BottomTab.Screen options={{headerShown: false}} name="Home" component={Homepage} />
      <BottomTab.Screen options={{headerShown: false}}name="History" component={PurchaseHistoryScreen} />
      <BottomTab.Screen options={{headerShown: false}} name="Start Live" component={StartLive}/>
...
export default function Dashboard({route,navigation}){
  ...
  return(
    ...
    <View style={styles.navbar}>
      <TouchableOpacity style={styles.hamburger} onPress={goToProfile}>
